...
namespace Microsoft.EntityFrameworkCore.Metadata.Builders
{
    ...
    public class PropertyBuilder<TProperty> : PropertyBuilder
    {
        ...
        /// <summary>
        ///     <para>
        ///         Configures the type to use to generate values for this property.
        ///     </para>
        ///     <para>
        ///         Values are generated when the entity is added to the context using, for example,
        ///         <see cref="DbContext.Add{TEntity}" />. Values are generated only when the value of the property
        ///         is null or the CLR default.
        ///     </para>
        ///     <para>
        ...
        ///         usually handled automatically by the Entity Framework provider.
        ///     </para>
        /// </summary>
        /// <returns> The same builder instance so that multiple configuration calls can be chained. </returns>
